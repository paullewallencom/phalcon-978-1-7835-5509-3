...
class ArticlesController extends BaseController
{
    ...
    public function listAction()
    {
        try {
            ...
            $st_output = $manager->restGet([], [], $page, $limit);
    ...
    /**
     * @ApiDescription(section="Articles", description="Retrieve a single article by slug")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/articles/slug/{slug}")
     * @ApiParams(name="slug", type="string", nullable=false, description="Article slug")
     * @ApiReturnHeaders(sample="HTTP 200 OK")
     * @ApiReturn(type="object", sample="{
     *  'items': [{
     *      'id':'int',
    ...
    /**
     * @ApiDescription(section="Articles", description="Retrieve articles by category slug")
     * @ApiMethod(type="get")
     * @ApiRoute(name="/articles/category/{slug}")
     * @ApiParams(name="slug", type="string", nullable=false, description="Category slug")
     * @ApiReturnHeaders(sample="HTTP 200 OK")
     * @ApiReturn(type="object", sample="{
     *  'items': [{
     *      'id':'int',
